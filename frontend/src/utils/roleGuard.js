...
export const getSidebarLinks = (role) => {
  const all = [
    ...
    { path: '/tables', label: 'Tables', icon: FiChair, roles: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.WAITER] },
    { path: '/orders', label: 'Orders', icon: FiShoppingCart, roles: [ROLES.SUPER_ADMIN, ROLES.ADMIN, ROLES.MANAGER, ROLES.WAITER, ROLES.CASHIER] },
